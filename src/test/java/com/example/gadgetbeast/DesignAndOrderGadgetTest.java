...
public class DesignAndOrderGadgetTest {
    ...
    public void testDesignATacoPage_HappyPath() throws Exception {
        ...
        buildAndSubmitATaco("Basic Gadget", "1", "4", "8", "11");
        clickBuildAnotherTaco();
        buildAndSubmitATaco("Another Gadget", "1", "4", "8", "11");
    ...
    public void testDesignATacoPage_InvalidOrderInfo() throws Exception {
        ...
        clickDesignATaco();
        assertDesignPageElements();
        buildAndSubmitATaco("Basic Taco", "1", "4", "8", "11");
    ...
    private void assertDesignPageElements() {
        ...
        assertThat(ingredientGroups.size()).isEqualTo(4);
